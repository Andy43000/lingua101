...
while True: #initiate loop
        ...
        d = {'absolument':'absolutely','actuellement':'currently','ailleurs':'elsewhere','alors':'so','ainsi':'thus; so','apres':'after','assez':'quite, fairly','aujourd hui':'today','aussi':'s well'} 
